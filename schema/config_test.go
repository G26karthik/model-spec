...
`,
		...
		// expected failure: precision is not a documented value
		{
			config: `
{
  "descriptor": {
...
`,
		...
		// valid: comma-separated precision values
		{
			config: `
{
  "descriptor": {
...
`,
		...
		// expected failure: comma-separated precision contains invalid value
		{
			config: `
{
  "descriptor": {
